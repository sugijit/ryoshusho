                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('receipts.update', $receipt) }}" method="POST" >
                        <div class="flex flex-wrap justify-between gap-4">
                            ...
                            <div class="w-full sm:w-[calc(50%-1rem)]  md:w-[calc(20%-1rem)]">
                                <div class="mb-4">
                                    <label for="taxprice" class="block text-gray-700 text-sm font-bold mb-2">相殺:</label>
                                    <input type="number" name="taxprice" id="taxprice" value="{{ $receipt->taxprice }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                </div>
                                <div class="mb-4">
